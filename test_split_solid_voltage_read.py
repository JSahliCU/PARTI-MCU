...
input('Is 10 V HF supply on, but amplifier supply off?')
...
input('Is HF tune up, and cable connected from Hack RF to FAM GO')

sm.fam_go_control.set_HF_tune_amp()

input('Check that amplifiers have not burned out, and that 5 V is supplied to amplifier')
