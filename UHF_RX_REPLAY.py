...
class UHF_RX_REPLAY(gr.top_block, Qt.QWidget):

    def __init__(self, center_frequency_offset_error=0.5):
        gr.top_block.__init__(self, "UHF RX REPLAY")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("UHF RX REPLAY")
        ...
        self.settings = Qt.QSettings("GNU Radio", "UHF_RX_REPLAY")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/tbbg/rx_data_rawUHF240125T133323', True, 0, 0)
...
def main(top_block_cls=UHF_RX_REPLAY, options=None):
    if options is None:
