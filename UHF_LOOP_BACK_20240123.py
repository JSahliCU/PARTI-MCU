...
class UHF_LOOP_BACK_20240123(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, center_frequency_offset_error=0.5):
        ...
        self.settings = Qt.QSettings("GNU Radio", "UHF_LOOP_BACK_20240123")
        ...
        labels = ['Balanced FM Demod', 'Root Raised Cosine Filter', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.qtgui_time_sink_x_0_1.set_y_axis(-1, 2)
        ...
        self.blocks_repeat_0_0_3 = blocks.repeat(gr.sizeof_float*1, 10)
        self.blocks_repeat_0_0_2 = blocks.repeat(gr.sizeof_char*1, (int)(samp_rate * (1 / baud_rate)))
        self.blocks_repeat_0_0_1_0 = blocks.repeat(gr.sizeof_float*1, 10)
        ...
        self.blocks_moving_average_xx_0_0 = blocks.moving_average_ff(2000000, 1/2000000, 4000000, 1)
        ...
        self.blocks_add_const_vxx_0_0_1 = blocks.add_const_ff(center_frequency_offset_error)
        self.blocks_add_const_vxx_0_0_0 = blocks.add_const_ff(demod_offset / delta_f)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_fm_demod_cf_0, 0), (self.blocks_moving_average_xx_0_0, 0))
        self.connect((self.analog_fm_demod_cf_0, 0), (self.blocks_sub_xx_0_0, 0))
        ...
        self.connect((self.blocks_add_const_vxx_0_0_0, 0), (self.blocks_vco_c_0_0, 0))
        self.connect((self.blocks_add_const_vxx_0_0_1, 0), (self.blocks_float_to_uchar_0_0, 0))
        self.connect((self.blocks_add_const_vxx_0_0_1, 0), (self.blocks_repeat_0_0_3, 0))
        ...
        self.connect((self.blocks_float_to_uchar_0_0, 0), (self.blocks_uchar_to_float_0_0, 0))
        ...
        self.connect((self.blocks_repeat_0_0_1, 0), (self.qtgui_time_sink_x_0_1, 0))
        self.connect((self.blocks_repeat_0_0_1_0, 0), (self.qtgui_time_sink_x_0_1, 1))
        self.connect((self.blocks_repeat_0_0_2, 0), (self.blocks_uchar_to_float_1, 0))
        self.connect((self.blocks_repeat_0_0_3, 0), (self.qtgui_time_sink_x_0, 2))
        self.connect((self.blocks_sub_xx_0, 0), (self.blocks_add_const_vxx_0_0, 0))
        self.connect((self.blocks_sub_xx_0_0, 0), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.blocks_sub_xx_0_0, 0), (self.root_raised_cosine_filter_0, 0))
        self.connect((self.blocks_uchar_to_float_0, 0), (self.blocks_repeat_0_0_1, 0))
        self.connect((self.blocks_uchar_to_float_0_0, 0), (self.blocks_repeat_0_0_1_0, 0))
        self.connect((self.blocks_uchar_to_float_1, 0), (self.blocks_add_const_vxx_0_0_0, 0))
        self.connect((self.blocks_unpacked_to_packed_xx_0, 0), (self.blocks_file_sink_0, 0))
        self.connect((self.blocks_vco_c_0_0, 0), (self.blocks_complex_to_mag_squared_0, 0))
        self.connect((self.blocks_vco_c_0_0, 0), (self.low_pass_filter_0, 0))
        self.connect((self.blocks_vector_source_x_0, 0), (self.blocks_repeat_0_0_2, 0))
        ...
        self.connect((self.digital_symbol_sync_xx_0_0, 0), (self.blocks_add_const_vxx_0_0_1, 0))
        ...
        self.connect((self.root_raised_cosine_filter_0, 0), (self.qtgui_time_sink_x_1, 1))
    ...
    def set_center_frequency_offset_error(self, center_frequency_offset_error):
        ...
        self.blocks_add_const_vxx_0_0_1.set_k(self.center_frequency_offset_error)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_repeat_0_0_2.set_interpolation((int)(self.samp_rate * (1 / self.baud_rate)))
        ...
        self.qtgui_time_sink_x_0_1.set_samp_rate(10 * self.samp_rate / self.baud_rate)
        self.qtgui_time_sink_x_1.set_samp_rate(self.samp_rate)
        self.root_raised_cosine_filter_0.set_taps(firdes.root_raised_cosine(1, self.samp_rate, self.baud_rate, 0.35, 5000))
    ...
    def set_delta_f(self, delta_f):
        ...
        self.set_bandwidth(self.M * self.delta_f)
        self.blocks_add_const_vxx_0_0_0.set_k(self.demod_offset / self.delta_f)
...
def main(top_block_cls=UHF_LOOP_BACK_20240123, options=None):
    if options is None:
