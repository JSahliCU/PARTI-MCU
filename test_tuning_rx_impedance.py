...
sm.fam_go_control.set_HF_RX()

print('Solid capacitance {0} pF'.format(sm.tuner.tb_solid.current_capacitance_pF))
print('Split capacitance {0} pF'.format(sm.tuner.tb_split.current_capacitance_pF))
